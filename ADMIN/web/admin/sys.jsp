...
<%@ page import="org.ahu.edu.bigdatalab.scm.model.Sys" %>
...
<%
    ...
    Note latestNote = Note.DAO.getLatestNote();
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="/photo/photo/<%=admin.get(Admin.photo)%>" class="img-circle" alt="User Image"/>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    通告通知
                        ...
                        <li>
                            ...
                            <div class="timeline-item">
                                <span class="time"><i class="fa fa-clock-o"></i> <%=latestNote.get(Note.time)%></span>
                                <h2 class="timeline-header"><font color="#3C8DBC">通告通知</font></h2>
                                <div class="timeline-body">

                                    <!--显示最新一条通告通知-->
                                    <%
                                        //id为-1表示数据没有改记录，该note是代码生成的
                                        if(latestNote.getInt(Note.id) == -1){
                                     %>
                                    <h2><font color="#72AFD6"><%=latestNote.get(Note.title)%></font></h2>
                                    <%} else {%>
                                    <h2><a href="sys-note-view.jsp?id=<%=latestNote.get(Note.id)%>"><%=latestNote.get(Note.title)%></a></h2>
                                    <%}%>
                                    <!--通告通知主体-->
                                    <section>
                                        <%=latestNote.get(Note.content)%>
                                    </section>
                                    <!--通告通知主体-->
                                    <!--显示最新一条通告通知-->
                                ...
                                <div class="timeline-footer">
                                    <div class="btn-group">
                                        <a class="btn btn-success" href="sys-note-add.jsp"><i class="fa fa-pencil"></i> 添加</a>
                                        <a class="btn btn-success" href="sys-note.jsp"><i class="fa fa-bars"></i> 查看所有</a>
                                    </div>
                                </div>
                            </div>
                        </li>
	              ...
	              <span class="bg-red">
	                系统设置
                        ...
                        <li>
                            <%
                                if (Sys.DAO.getLoginState() == Sys.LOGIN_ENABLE) {
                            %>
                            <i class="fa fa-user bg-green"></i>
                            <div class="timeline-item">
                                <h2 class="timeline-header no-border"><font color="#3C8DBC">登陆设置</font></h2>
                                <div class="timeline-body">
                                    当前系统已经设置为允许用户登陆
                                </div>
                                <div class="timeline-footer">
                                    <button class="btn btn-danger" onclick="sysUserLoginDisable()"><i class="fa fa-times"></i> 禁止用户登陆</button>
                                </div>
                            </div>
                            <% } else { %>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-footer">
                                    <button class="btn btn-success" onclick="sysUserLoginEnable()"><i class="fa fa-check"></i> 允许用户登陆</button>
                                </div>
                            </div>
                            <% } %>
                        </li>
                        ...
                        <li>
                            <%
                                if(Sys.DAO.getJobState() == Sys.JOB_ENABLE ){
                            %>
                            <i class="fa fa-unlock bg-green"></i>
                            <div class="timeline-item">
                                <h2 class="timeline-header"><font color="#3C8DBC">任务设置</font></h2>
                                <div class="timeline-body">
                                    当前系统已经设置为允许提交任务
                                </div>
                                <div class="timeline-footer">
                                    <button class="btn btn-danger" onclick="sysUserJobDisable()"><i class="fa fa-times"></i> 禁止提交任务</button>
                                </div>
                            </div>
                            <% } else { %>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-footer">
                                    <button class="btn btn-success" onclick="sysUserJobEnable()"><i class="fa fa-check"></i> 允许提交任务</button>
                                </div>
                            </div>
                            <% } %>
                        </li>
