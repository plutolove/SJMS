...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                新建通告通知
                <small>新创建一条通告通知</small>
            </h1>
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> 系统管理</li>
                <li><a href="sys">系统设置</a></li>
                <li><a href="sys-note.jsp">通告通知</a></li>
                <li class="active">新建通告通知</li>
            </ol>
        </section>

        <!-- Main content -->
        <section class="content">
            <form action="sys/addNote" method="post">
                <div class="box">
                    <div class="box-header">
                        <input class="form-control input-lg" type="text" placeholder="输入标题" id="title" name="title">
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body pad">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-success" href="sys-note.jsp">取消</a>
                        </div>
