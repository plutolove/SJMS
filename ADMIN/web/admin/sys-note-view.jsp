        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3><%=note.get(Note.title)%> <small> <%=note.get(Note.time)%></small></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body pad">
                    ...
                    <div class="btn-group">
                        <a class="btn btn-success" href="sys-note.jsp"><i class="fa fa-chevron-left"></i>返回</a>
                    </div>
                    <div class="btn-group">
                        <a class="btn btn-primary" href="sys-note-edit.jsp?id=<%=noteId%>"><i class="fa fa-pencil"></i>修改</a>
                    </div>
                </div>
            </div>
