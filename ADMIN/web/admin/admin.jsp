...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <button class="btn btn-primary" style="margin-bottom: 10px;" onclick="adminAdd()"><i class="fa fa-user-plus"></i> 新建管理员</button>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table id="cluster_list" class="table table-bordered table-hover">
                                ...
                                %>
                                <tr>
                                    <td><a href="#"><%=item.get(Admin.name)%></a></td>
                                    <td><a href="mailto:<%=item.get(Admin.email)%>"><%=item.get(Admin.email)%></a></td>
                                    <td>在线</td>
                                    <td><%=item.get(Admin.number)%></td>
                                    <td><%=item.get(Admin.loginTime)%></td>
                                    <td><div class="btn-group">
                                        <button type="button" class="btn btn-default" onclick="adminDelete(<%=item.get(Admin.id)%>, $(this))">删除账号</button>
                                    </div>
                                    </td>
                                </tr>
                                <% }%>
