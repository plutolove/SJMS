...
<%@ page import="org.ahu.edu.bigdatalab.scm.bean.Worker" %>
                            ...
                            <table id="cluster_list" class="table table-bordered table-hover">
                                ...
                                <%
                                    for (Worker worker : list) {
                                        //去除端口号的部分 :8000
                                        String address = worker.getAddress().split(":")[0];
                                %>
                                <tr>
                                    <td><a href="javascript:clusterInfo('<%=address%>')"><%=worker.getId()%></a></td>
                                    <td><a href="javascript:clusterSSH('<%=address%>')"><%=worker.getAddress()%></a></td>
                                    <td><%=worker.getState()%></td>
                                    <td><%=worker.getCores()%></td>
                                    <td><%=worker.getMemory()%></td>
                                    <td><div class="btn-group">
                                        <button type="button" class="btn btn-default" onclick="clusterReboot(0)"><i class="fa fa-refresh"></i> 重启</button>
                                        <button type="button" class="btn btn-default" onclick="clusterShutdown(0)"><i class="fa fa-power-off"></i> 关机</button>
                                        <button type="button" class="btn btn-default" onclick="clusterDisconnect(0)"><i class="fa  fa-close"></i> 断开连接</button>
                                    </div>
                                    </td>
                                </tr>
                                <% } %>
