...
public class HDFSService {
    ...
    private String HDFSUrl = "http://172.19.142.65:8080";
    ...
    public List<FileModel> getFileList(String fullPath){
        try {
            Document document = Jsoup.connect(HDFSUrl + "/getFileList")
                    .data("userid", id)
//                    .data("passwd", password)
    ...
    public int mkdir(String fullPath, String filename){
        try {
            Document document = Jsoup.connect(HDFSUrl + "/mkdir")
                    .data("userid", id)
//                    .data("passwd", password)
                    .data("full_path", "/home/" + id + fullPath)
    ...
    public int deleteFile(String fullPath){
        try {
            Document document = Jsoup.connect(HDFSUrl + "/deleteFile")
                    .data("userid", id)
//                    .data("passwd", password)
                    .data("full_path", "/home/" + id + fullPath)
                    .post();
...
//            System.out.print(result);
    ...
    public int renameFile(String path, String preFilename, String newName){
        try {
            Document document = Jsoup.connect(HDFSUrl + "/renameFile")
                    .data("userid", id)
//                    .data("passwd", password)
    ...
    public String getLines(String path){
        try {
            Document document = Jsoup.connect(HDFSUrl + "/getLines")
                    .data("userid", id)
//                    .data("passwd", password)
