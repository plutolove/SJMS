...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="/loginP" method="post" id="form">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="button" onclick="javascript:submitForm();" class="btn btn-primary btn-block btn-flat">登 陆</button>
                </div>
                <!-- /.col -->
            </div>
        </form>

        <a href="/register">没有账号？注册一个</a><br>
        <a href="/reset_password">忘记密码？</a><br>
